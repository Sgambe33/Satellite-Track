...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script/leaflet-sidebar.js":[function(require,module,exports) {
L.Control.Sidebar = L.Control.extend({
  includes: L.Evented.prototype || L.Mixin.Events,
  options: {
    position: "left"
  },
  initialize: function initialize(t, s) {
    var i, e;
    for (L.setOptions(this, s), this._sidebar = L.DomUtil.get(t), L.DomUtil.addClass(this._sidebar, "sidebar-" + this.options.position), L.Browser.touch && L.DomUtil.addClass(this._sidebar, "leaflet-touch"), i = this._sidebar.children.length - 1; i >= 0; i--) {
      "DIV" == (e = this._sidebar.children[i]).tagName && L.DomUtil.hasClass(e, "sidebar-content") && (this._container = e);
    }
    for (this._tabitems = this._sidebar.querySelectorAll("ul.sidebar-tabs > li, .sidebar-tabs > ul > li"), i = this._tabitems.length - 1; i >= 0; i--) {
  ...
  addTo: function addTo(t) {
    ...
    for (s = this._closeButtons.length - 1; s >= 0; s--) {
      i = this._closeButtons[s], L.DomEvent.on(i, "click", this._onCloseClick, this);
    }
    return this;
  },
  ...
  remove: function remove(t) {
    ...
    for (this._map = null, s = this._tabitems.length - 1; s >= 0; s--) {
      i = this._tabitems[s], L.DomEvent.off(i.querySelector("a"), "click", this._onClick);
    }
    for (s = this._closeButtons.length - 1; s >= 0; s--) {
      i = this._closeButtons[s], L.DomEvent.off(i, "click", this._onCloseClick, this);
    }
    return this;
  },
  open: function open(t) {
    ...
    for (s = this._panes.length - 1; s >= 0; s--) {
      (i = this._panes[s]).id == t ? L.DomUtil.addClass(i, "active") : L.DomUtil.hasClass(i, "active") && L.DomUtil.removeClass(i, "active");
    }
    for (s = this._tabitems.length - 1; s >= 0; s--) {
      (i = this._tabitems[s]).querySelector("a").hash == "#" + t ? L.DomUtil.addClass(i, "active") : L.DomUtil.hasClass(i, "active") && L.DomUtil.removeClass(i, "active");
    }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script/leaflet-sidebar.js"], null)
//# sourceMappingURL=/leaflet-sidebar.11a80a9f.js.map